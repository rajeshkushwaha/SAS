            ...
            setTimeout(() => {
                ...
                if (data == null) {
                    data = [
                        ...
                        { "completed": false, "important": true, "name": "Do a sas how-to writeup", "description": "" },
                        {
                            ...
                            " using aspnet-core/angular6. The tutorial will focus on getting productive with the technology right away rather than the details on how and why they work so audience can get onboard sasly."
                        },
                    ];
                }
