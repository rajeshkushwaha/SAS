...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Question>().Property(q => q.question).IsRequired();
            builder.Entity<Question>().Property(q => q.questiontype).IsRequired();
            builder.Entity<Question>().Property(q => q.technology).IsRequired(); //Skill
            builder.Entity<Question>().Property(q => q.expertieslevel).IsRequired();
            builder.Entity<Question>().ToTable($"App{nameof(this.Questions)}");
        }
